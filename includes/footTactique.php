...
/*----------  Equipe Ext  ----------*/	
	if ($tactiqueB == "") {
		...
		$lignes[] = array('','','','','',$EquipeExt3,$EquipeExtCap3,$EquipeExtNum3,$ClubExt);
		$lignes[] = array('','','','','',$EquipeExt4,$EquipeExtCap4,$EquipeExtNum4,$ClubExt);
		$lignes[] = array('','','','','',$EquipeExt5,$EquipeExtCap5,$EquipeExtNum5,$ClubExt);
		$lignes[] = array('','','','','',$EquipeExt6,$EquipeExtCap6,$EquipeExtNum6,$ClubExt);
		$lignes[] = array('','','','','',$EquipeExt7,$EquipeExtCap7,$EquipeExtNum7,$ClubExt);
		$lignes[] = array('','','','','',$EquipeExt8,$EquipeExtCap8,$EquipeExtNum8,$ClubExt);
		$lignes[] = array('','','','','',$EquipeExt9,$EquipeExtCap9,$EquipeExtNum9,$ClubExt);
		$lignes[] = array('','','','','',$EquipeExt10,$EquipeExtCap10,$EquipeExtNum10,$ClubExt);
		$lignes[] = array('','','','','',$EquipeExt11,$EquipeExtCap11,$EquipeExtNum11,$ClubExt);
	}	
