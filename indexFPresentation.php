...
<!-- ////////////////////////////////////////////////////
	...
	<section id="desktop">
		...
		<div class="BlocLogosEquipes">
			<span class="BlocEquipeDom">
						<div class="blocInfo">
							<div class="titre">
								...
								<div id="EquipeGauche" class="equipeA"><?php echo $DatasFront[2]; ?><div class="classScore"><?php echo $DatasFront[26]; ?></div></div>
							</div>
						</div>
			</span>
			<span class="BlocEquipeExt">
						<div class="blocInfo">
							<div class="titre">
								<div class="equipeB"><?php echo $DatasFront[3]; ?><p class="classScore"><?php echo $DatasFront[27]; ?></p></div>
								<img class="logoDroite" src="css/images/clubs/<?php echo $sport.'/'.ddc($DatasFront[3]); ?>.png">
							</div>
						</div>
			</span>
		...
		<div id="titreConfrontationsDesk" class="BlocTitreConfrontations mask">
			<hr class="TraitTitreConfrontations"><h2 id="texteConfrontationsDesk"><?php echo confrontations($DatasFront[23],$b); ?></h2><hr class="TraitTitreConfrontations">
		</div>
		<div class="BlocConfrontations">
				<img class="logoGauche" src="css/images/clubs/<?php echo $sport.'/'.ddc($DatasFront[2]); ?>.png">
	...
	<script type="text/javascript">effacePortion();</script>
	<script type="text/javascript"> messageConfontation();</script>
